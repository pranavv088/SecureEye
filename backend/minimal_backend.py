#!/usr/bin/env python3
"""
Minimal SecureEye Backend - Just the essentials
"""
...
def health_check():
    ...
    return jsonify({
        ...
        'version': 'minimal-1.0',
        'message': 'SecureEye Backend is running (minimal mode)'
    })
...
def handle_connect():
    ...
    emit('status', {'message': 'Connected to SecureEye AI backend (minimal mode)'})
    ...
    if camera_id not in active_cameras:
        ...
        def simulate_detections():
            ...
            while camera_id in active_cameras:
                ...
                # Simulate detection every 2 cycles
                if count % 2 == 0:
                    detections = {
                        'motion': {
                            'detected': True,
...
if __name__ == '__main__':
    print("🚀 Starting SecureEye AI Backend (Minimal Mode)...")
